...
function LikeCommentSave({
  ...
  return (
    <div className="button-container">
      ...
      <div className="like-button" onClick={handleCommentClicked}>
        <div className="like-text">Comment</div>
        <img src="/icons/comment.svg" alt="like" className="comment-image" />
      </div>
      <div className="like-button" onClick={handleSaveClicked}>
        <div
          className="like-text"
