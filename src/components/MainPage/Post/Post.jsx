...
function Post({
  ...
  const handleCommentSubmit = async () => {
    ...
    // Fetch the actual Post to get the restaurantName
    ...
    notification.set(
      "message",
      `${userPointer.get("name")} commented on your post about ${postObject.get(
        "restaurantName"
      )}`
    );
    notification.set("userToBeNotified", postObject.get("userId")); // User that gets notiff
  ...
  return (
    <div className="post">
      <div className="post-header">
        <ProfilePicture imgSrc={imgSrcUser} height="40px" />
      ...
      <div className="post-content">
        ...
        <div className="post-image-container">
          <img src={imgSrcRestaurant} alt="Restaurant" className="post-image" />
        ...
        <LikeCommentSave
          like={like}
          setLike={setLike}
          handleLikeClicked={() => handleLikeClick(id)}
        ...
        {showComments ? (
          <div className="comments">
            <div className="comment-section">
              <ProfilePicture imgSrc={imgSrcCommenter} height="35px" />
